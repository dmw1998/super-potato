...
# For example 2, I keep the right side of the domain as the failure domain of the next level

def failure_level(theta, u, u_max, p0=0.1, x_min=0.0, x_max=1.0):
    # Cut both sides of the domain
    # keep the failure points as the boundary of the failure domain of the next level
